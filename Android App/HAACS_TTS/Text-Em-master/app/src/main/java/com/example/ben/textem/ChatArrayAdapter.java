...
public class ChatArrayAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public ChatArrayAdapter(Context context, int textViewResourceId) {super(context, textViewResourceId);}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        chatText.setBackgroundResource(chatMessageObj.left ? R.drawable.send : R.drawable.receive);
